...
| accessibility          | `{ toastAriaLive?: string; toastRole?: string; closeButtonLabel?: string }`               | `{ toastAriaLive: "assertive; toastRole: "alert", closeButtonLabel: "close" }` | Accessibility options. Define the `role` attribute of the toast, `aria-live` for announcing the toast, and the `aria-label` attribute of the close button.                                                                                                  |
